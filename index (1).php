        ...
        <div class="container-fluid">
          <div class="inner__article col-lg-8">
            ...
            <div class="block">
              <div class="row">
                <div class="col">
                  <h4 class="newest">IT</h4>
                </div>
                <div class="col text-right">
                  <a class="articles__link" href="articles.php?page=1&categorie=3">All articles</a>
                </div>
              </div>
              <div class="row">
                  <?php 
            ...
            <div class="block">
              <div class="row">
                <div class="col">
                  <h4 class="newest">Languages</h4>
                </div>
                <div class="col text-right">
                  <a class="articles__link" href="articles.php?page=1&categorie=4">All articles</a>
                </div>
              </div>
              <div class="row">
                  <?php 
            ...
            <div class="block">
              <div class="row">
                <div class="col">
                  <h4 class="newest">Human Rights</h4>
                </div>
                <div class="col text-right">
                  <a class="articles__link" href="articles.php?page=1&categorie=36">All articles</a>
                </div>
              </div>
              <div class="row">
                  <?php 
